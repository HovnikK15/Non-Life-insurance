...
## ----opt_boost_it1---------------------------------------------------------------
best.iter.oob <- gbm.perf(gbm_sim, method = "OOB", oobag.curve = TRUE, overlay = TRUE)
print(best.iter.oob)
...
## ----pdp_sim_resp----------------------------------------------------------------
par(mfrow = c(2,2))
plot(gbm_sim, 1, best.iter.cv, type = "response")
plot(gbm_sim, 2, best.iter.cv, type = "response")
plot(gbm_sim, 3, best.iter.cv, type = "response")
plot(gbm_sim, 4, best.iter.cv, type = "response")
...
## file.exists("2020-05-08 Gradient boosting with gbm.Rmd")
## purl("2019-05-08 Gradient boosting with gbm.Rmd")

...
# ne vem če bom to rabila
#a <- min(mtpl$age):max(mtpl$age)
#freq_glm_age <- glm( nclaims ~ age, offset=log(expo), data = mtpl, family = poisson(link ="log"))
#pred_glm_age <- predict(freq_glm_age, newdata = data.frame(age = a, expo = 1), type = "terms", se.fit = TRUE )
#b_glm_1 <- pred_glm_age$fit
#l_glm_1 <- pred_glm_age$fit - qnorm(0.975) * pred_glm_age$se.fit
#u_glm_1 <- pred_glm_age$fit + qnorm(0.975) * pred_glm_age$se.fit
#df <- data.frame (a, b_glm_1, l_glm_1, u_glm_1)
#p_glm_age <- ggplot(df, aes(x= a)) + ylim(-0.5,1)
#p_glm_age <- p_glm_age + geom_line(aes(a, b_glm_1), size = 1, col = "red")
#p_glm_age <- p_glm_age + geom_line(aes(a, u_glm_1), size =0.5, linetype = 2, col ="red") + geom_line(aes(a, l_glm_1), size = 0.5, linetype = 2, col = "red")
#p_glm_age <- p_glm_age + xlab("age") + ylab("fit") + theme_bw()
#p_glm_age
```
...
sev_glm_2 <- glm(amount ~ age + codposs + agecar + fuelc + split + usec + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_2) #AIC = 308016.8 model 1 is a better fit
...
sev_glm_3 <- glm(amount ~ age + sex + codposs + agecar + fuelc + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_3) #AIC = 307983.8 this model is a better fit
...
sev_glm_5 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + split + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_5) #AIC = 307990.4 model 4 is  a better fit
...
sev_glm_6 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + split + fleetc + sportc + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_6) #AIC = 308132.9 model 4 is  a better fit
...
sev_glm_7 <- glm(amount ~ age + sex + age:sex + codposs + agecar + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_7) #AIC = 308003.7 model 4 is a better fit
...
sev_glm_8 <- glm(amount ~ age + sex + age:sex + codposs + fuelc + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_8) #AIC = 308090.9 model 4 is a better fit
...
sev_glm_9 <- glm(amount ~ age + sex + age:sex + agecar + fuelc + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_9) #AIC = 307978.4 model 4 is a better fit

sev_glm_10 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + split + fleetc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),data = mtpl)
AIC(sev_glm_10) #AIC = 307984.2 model 4 is a better fit

sev_glm_11 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + split  + fleetc + sportc + coverp, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_11) #AIC = 308125.8 model 4 is a better fit

sev_glm_12 <- glm(amount ~ age + sex + age:sex, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_12) #AIC =  309148.2 model 4 is a better fit

sev_glm_13 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_13) #AIC = 308377.6 model 4 is a better fit 

sev_glm_14 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_14) #AIC = 307887.1 this model is a better fit

sev_glm_15 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc, offset =log(expo), family = Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_15) #AIC = 307841.9 this model is a better fit
sev_glm_16 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs, offset =log(expo), family = Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_16) #AIC = 307828.9 this model is a better fit

sev_glm_17 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs +age:split, offset =log(expo), family = Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_17) #AIC = 307770.4 this model is a better fit

sev_glm_18 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs +age:split + fleetc:sportc, offset =log(expo), family = Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_18) #AIC = 307772.2 model 17 is a better fit

sev_glm_19 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs + age:split + fuelc:codposs, offset =log(expo), family =Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_19) #AIC = 307690.5 this model is a better fit

sev_glm_20 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs + age:split + fuelc:codposs + codposs:powerc, offset =log(expo), family = Gamma(link = "log"),
                  data = mtpl)
AIC(sev_glm_20) #AIC = 307626.1 this model is a better fit
```
...
AIC_sev$model <- c("1 + age + sex + codposs + agecar + fuelc + split + usec + fleetc + sportc + coverp + powerc","1 + age + codposs + agecar + fuelc + split + usec + fleetc + sportc + coverp + powerc","1 + age + sex + codposs + agecar + fuelc + split + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + split  + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + split + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + split + fleetc + sportc + powerc","1 + age + sex + age:sex + codposs + agecar + split + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + fuelc + split + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + agecar + fuelc + split + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + split + fleetc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + split  + fleetc + sportc + coverp","1 + age + sex + age:sex","1 + age + sex + age:sex + codposs + agecar + fuelc + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs +age:split","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs +age:split + fleetc:sportc","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs + age:split + fuelc:codposs","1 + age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs + age:split + fuelc:codposs + codposs:powerc")
...
bootobject <- boot(data = mtpl, statistic = bs, R = 1000, formula = amount ~ age + sex + age:sex + codposs + agecar + fuelc + agecar:fuelc + split + fleetc + sportc + coverp + powerc + sex:powerc + age:codposs + age:split + fuelc:codposs + codposs:powerc )
bootobject
plot(bootobject)

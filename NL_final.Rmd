...
emp_freq_male <- exp(coef(freq_glm_1)[1]+coef(freq_glm_sex)[2])
...
freq_glm_2 <- glm(nclaims ~ age + codposs + agecar + fuelc + split + usec + fleetc + sportc + coverp + powerc, offset =log(expo), family =poisson(link = "log"),
                  data = mtpl)
summary(freq_glm_2) #AIC = 126168 model 1 is a better fit
freq_glm_3 <- glm(nclaims ~ age + sex + codposs + agecar + fuelc + split + fleetc + sportc + coverp + powerc, offset =log(expo), family =poisson(link = "log"),
                  data = mtpl)
summary(freq_glm_3) #AIC = 126165 this model is a better fit
...
######sev_glm_11 <- glm(amount ~ age + sex + age:sex + codposs + agecar + fuelc + split + fleetc + coverp + powerc, offset =log(expo), family =poisson(link = "log"),
                  data = mtpl)
summary(freq_glm_11) #AIC = 126143 this model is a better fit
